    ...
    with tf.compat.v1.Session() as sess:
        ...
        for node_id in top_k:
           ...
           # writeResultOnImage(image, letter[0].upper() + ", " + "{0:.2f}".format(s[0] * 100) + "% Confidence")
            ...
            # if letter[0] == "neutral":
            #     mixer.music.load(
            #         "E:\ARU\Majorproject\preprocessing_data\Songs\Surprise\pavizha_mazha_athiran_official_song_video_fahad_faasil_sai_pallavi_vivek_-7032331408480181537.mp3")
            #     mixer.music.play()
            #     time.sleep(5000)
            #     mixer.music.stop()
            # elif letter[0] == "happy":
            #     mixer.music.load(
            #         "E:\ARU\Majorproject\preprocessing_data\Songs\happy\ roja_hariharan_sp_balasubramaniam_duet_-2740312736442182869.mp3")
            #     mixer.music.play()
            #     time.sleep(5000)
            #     mixer.music.stop()
            # elif letter[0] == "sad":
            #     mixer.music.load(
            #         "E:\ARU\Majorproject\preprocessing_data\Songs\sad\ bebe_rexha_i_m_a_mess_official_music_video_U0Wj8XIByoK-gucZxzK2.mp3mp3")
            #     mixer.music.play()
            #     time.sleep(100)
            #     mixer.music.stop()
            # elif letter[0] == "angry":
            #     mixer.music.load("E:\ARU\Majorproject\preprocessing_data\Songs\ angry\ Give Me Some Shine.mp3")
            #     mixer.music.play()
            #     time.sleep(100)
            #     mixer.music.stop()
            # elif letter[0] == "fear":
            #     mixer.music.load("E:\ARU\Majorproject\preprocessing_data\Songs\ fear \ alan_walker_alone_Fgk963IByoK-gucZlNZB.mp3")
            #     mixer.music.play()
            #     time.sleep(100)
            #     mixer.music.stop()
            # elif letter[0] == "surprise":
            #     mixer.music.load(
            #         "E:\ARU\Majorproject\preprocessing_data\Songs\Surprise\pavizha_mazha_athiran_official_song_video_fahad_faasil_sai_pallavi_vivek_-7032331408480181537.mp3")
            #     mixer.music.play()
            #     time.sleep(100)
            #     mixer.music.stop()
            # elif letter[0] == "disgust":
            #     mixer.music.load(
            #         "E:\ARU\Majorproject\preprocessing_data\Songs\disgust\ alan_walker_sabrina_carpenter_farruko_on_my_way_pgm-B3MByoK-gucZ0pU5.mp3")
            #     mixer.music.play()
            #     time.sleep(100)
            #     mixer.music.stop()
