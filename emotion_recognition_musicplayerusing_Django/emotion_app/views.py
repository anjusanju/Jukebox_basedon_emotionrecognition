    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'main.html',
                          {"happy_songs": happy_songs, "angry_songs": angry_songs, "disgust_songs": disgust_songs,
                           "fear_songs": fear_songs, "neutral_songs": neutral_songs, "sad_songs": sad_songs,
...
def upload_new_song(request):
    if request.method == 'POST':
        ...
        copyfile(os.path.dirname(__file__) + '/test_songs/' + song,
                 os.path.dirname(__file__) + '/../static/assets/js/songs/' + folder + '/' + song)
        return HttpResponse("response[0]", status=200)
